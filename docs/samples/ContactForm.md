...
<html>
    ...
    <body layout="y">
        ...
        <label uiid="Title">Contact Details</label>
        <table>
            <tr>
                <td>First Name</td>
        ...
        <label uiid="Title">Preferences</label>
        <table>
            <tr>
                <td>Software</td>
...
From [CN1MLDemo.java](../../CN1MLDemos/src/ca/weblite/codename1/cn1ml/demos/CN1MLDemo.java#L114)
...
![Lumia Screenshot](screenshots/ContactForm-lumia.png)

**iOS Skin**

![iOS Screenshot](screenshots/ContactForm-ios.png)