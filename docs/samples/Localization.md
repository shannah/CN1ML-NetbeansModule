## CN1ML Sample: Localization

[Return to Samples](../../README.md#more-samples)

This sample is part of the [CN1MLDemos](../../CN1MLDemos) project and has been adapted from the [Contact Form Sample](ContactForm.md).  It demonstrates how to use localization in your CN1ML templates.



####Some things to Notice:

1. The `i18n` attribute is used to specify the localization key to use for the text contained inside a tag.


### CN1ML Source:
From [ContactFormI18n.cn1ml](../../CN1MLDemos/src/ca/weblite/codename1/cn1ml/demos/ContactFormI18n.cn1ml)
...
<html>
    ...
    <body layout="y">
        ...
        <label uiid="Title" i18n="contact details">Contact Details</label>
        
        <table>
            <tr>
                <td i18n="first name">First Name</td>
                <td><input type="text" name="firstName"/></td>
            </tr>
            <tr>
                <td i18n="last name">Last Name</td>
                <td><input type="text" name="lastName"/></td>
            </tr>
            <tr>
                <td i18n="home country">Home Country</td>
                <td>
                    <select name="countrySelect">
                        <option i18n="Canada">Canada</option>
                        <option i18n="United States" >United States</option>
                        <option i18n="France">France</option>
                        <option i18n="Spain">Spain</option>
                    </select>
                </td>
            </tr>
            <tr>
                <td colspan="2" i18n="bio label">Bio (Paragraph)</td>
            </tr>
            <tr>
                <td colspan="2">
        ...
        <label uiid="Title" i18n="preferences">Preferences</label>
        <table>
            <tr>
                <td i18n="software">Software</td>
                <td><input type="checkbox" name="softwareCheckbox"/></td>
            
                <td i18n="hardware">Hardware</td>
                <td><input type="checkbox" name="hardwareCheckbox"/></td>
            </tr>
            
        </table>
        <button name="saveButton" i18n="save">Save</button>
...
From [ContactForm.java](../../CN1MLDemos/src/ca/weblite/codename1/cn1ml/demos/ContactForm.java)
...
class ContactFormI18n {
    ...
    public ContactFormI18n(java.util.Map context) {
    ...
    private Container buildUI() throws Exception {
        ...
        node3.addComponent(new Label(com.codename1.ui.plaf.UIManager.getInstance().localize("first name", "First Name")));
        ...
        node6.addComponent(new Label(com.codename1.ui.plaf.UIManager.getInstance().localize("last name", "Last Name")));
        ...
        node9.addComponent(new Label(com.codename1.ui.plaf.UIManager.getInstance().localize("home country", "Home Country")));
        ...
        node12.addComponent(new Label(com.codename1.ui.plaf.UIManager.getInstance().localize("bio label", "Bio (Paragraph)")));
        ...
        node17.addComponent(new Label(com.codename1.ui.plaf.UIManager.getInstance().localize("software", "Software")));
        ...
        node20.addComponent(new Label(com.codename1.ui.plaf.UIManager.getInstance().localize("hardware", "Hardware")));
        ...
        node23.setText(com.codename1.ui.plaf.UIManager.getInstance().localize("save", "Save"));
    ...
    private void init8_node11(ComboBox self, Container parent) {
        ...
        opts.add(com.codename1.ui.plaf.UIManager.getInstance().localize("Canada", "Canada"));
        opts.add(com.codename1.ui.plaf.UIManager.getInstance().localize("United States", "United States"));
        opts.add(com.codename1.ui.plaf.UIManager.getInstance().localize("France", "France"));
        opts.add(com.codename1.ui.plaf.UIManager.getInstance().localize("Spain", "Spain"));
...
![Lumia Screenshot](screenshots/contactform-i18n-ios.png)
