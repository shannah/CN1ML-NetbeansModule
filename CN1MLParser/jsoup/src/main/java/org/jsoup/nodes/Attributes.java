...
public class Attributes implements Iterable<Attribute>, Cloneable {
    ...
    public String get(String key) {
        ...
        Attribute attr = attributes.get(Format.formatAttributeName(key));
    ...
    public void remove(String key) {
        ...
        if (attributes == null)
            return;
        attributes.remove(Format.formatAttributeName(key));
    }
    ...
    public boolean hasKey(String key) {
        return attributes != null && attributes.containsKey(Format.formatAttributeName(key));
    }
