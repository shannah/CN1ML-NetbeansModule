...
private void init13_node14(TextArea self, Container parent){
StringBuilder sb = new StringBuilder();sb.append("<script>");
sb.append(System.getProperty("line.separator"));
sb.append("                            self.setText(\"barrrrrrrr\");");
sb.append(System.getProperty("line.separator"));
sb.append("                            ");
sb.append(System.getProperty("line.separator"));
sb.append("                        </script>");
sb.append(System.getProperty("line.separator"));
self.setText(com.codename1.ui.plaf.UIManager.getInstance().localize("bioval", sb.toString()));
}
private void init14_node17(Container self, Container parent){
TableLayout l = (TableLayout)parent.getLayout(); TableLayout.Constraint c = l.createConstraint(0,0); c.setVerticalSpan(1); c.setHorizontalSpan(1); parent.addComponent(c, self);
}
private void init15_node18(Container self, Container parent){
TableLayout l = (TableLayout)parent.getLayout(); TableLayout.Constraint c = l.createConstraint(0,1); c.setVerticalSpan(1); c.setHorizontalSpan(1); parent.addComponent(c, self);
}
public CheckBox getSoftwareCheckbox(){
      return (CheckBox)get("softwareCheckbox");
      }
private void init16_node20(Container self, Container parent){
...
private void init17_node21(Container self, Container parent){
